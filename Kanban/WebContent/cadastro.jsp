...
<body>
	...
	<div class = "container">
		<form class="col s12" name="formulario"  action="incluir_obs" >
		<input id="id" type="hidden" />
		<div class="row">
			<div class="input-field col s2">
				<select id="leito" name="leito">	
					<option value="" disabled selected>Selecione</option>				
					<c:forEach var="kanban" items="${resultado}">
						<option value="${kanban.getLeito()}">${kanban.getLeito()}</option>     
          			</c:forEach>
				</select>
				<label>Leito</label>
			</div>
		...
		<div class="row">
			<div class="input-field col s2">
				<input id="prontuario" name="prontuario" type="text" readonly="true">
				<label for="prontuario">Prontuário</label>
			</div>
			<div class="input-field col s10">
				<input id="nome" name="nome" type="text"  readonly="true">
				<label for="nome">Nome</label>
			</div>						
		</div>
		<div class="row">
			<div class="input-field col s10">
				<input id="observacao" name="observacao" type="text" length="30">
				<label for="observacao">Observação</label>
			</div>
			<div class="input-field col s2">
				<input id="fugulin" name="fugulin" type="text">
				<label for="fugulin">Pontuação FUGULIN</label>
			</div>						
		</div>
        <div>
            <div class="center-align">
                <a onclick="gravar();" class="btn light-green lighten"><i class="material-icons left"></i>Gravar</a>
