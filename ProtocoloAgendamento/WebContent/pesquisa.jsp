...
<body>
	...
	<div id="header-bar"> <div class="container"></div> </div>	
		<div class = "container">
			<form class="col s12" name="formulario"  action="carrega_pesquisa" >			
			<div class="row">
				<div class="input-field col s2">
					<input id="numero_paciente" name="numero_paciente" type="text" onclick="">
					<label for="numero_paciente">Prontuário MV</label>
				</div>			
             </div>	
		</div>
  	</div>	
